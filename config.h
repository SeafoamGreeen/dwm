...
static const Rule rules[] = {
	...
	RULE(.title = "doublecmd", .isfloating = 1)
	/* RULE(.class = "Doublecmd", .isfloating = 1) */
	/* RULE(.class = "Gimp", .tags = 1 << 4) */
...
static const char *mousecmd[]  = {"mouseless","-c","/home/seafoam/.config/mouseless/config2.yaml", NULL };
...
/* rezise */
	...
	{ MODKEY|Mod1Mask,              XK_plus,       aspectresize,           {.i = +24} },
	{ MODKEY|Mod1Mask,              XK_minus,      aspectresize,           {.i = -24} },
...
/* gaps */
	/* { MODKEY|Mod1Mask,              XK_plus,       incrgaps,               {.i = +3 } }, */
...
/* scratchpads */
  ...
  /* { MODKEY,                       XK_n,      togglecanfocusfloating,   {0} }, */
	...
	{ Mod3Mask,             XK_Pause,         xrdb,                   {.v = NULL } },

  {MODKEY|ShiftMask, XK_s, spawn, SHCMD("flameshot gui") },
  {MODKEY|ShiftMask, XK_p, spawn, SHCMD("picom || killall picom") },

  {MODKEY, XK_Left, spawn, SHCMD("xrandr --output eDP-1 --rotate left") },
  ...
  {MODKEY|Mod1Mask,            XK_comma,    floatpos,   {.v = " 50% 100%" } }, // ↓

  /* center window and make diferent sizes */
	{ MODKEY,           XK_c,            floatpos,               {.v = "50% 50% 84% 94%" } }, // ·
